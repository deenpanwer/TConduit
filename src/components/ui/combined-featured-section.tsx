...
import { Activity, ArrowRight, Files, Flower, GalleryVerticalEnd, MapPin, Monitor } from 'lucide-react'
...
export default function CombinedFeaturedSection() {
  const featuredCasestudy = {
    ...
    subtitle: 'in Pakistan. Seamless AI-powered monitoring for modern distributed teams.',
  }
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 md:grid-rows-2">
        ...
        <div className="relative rounded-none overflow-hidden bg-muted border border-gray-200 dark:border-gray-800 p-4">
          ...
          <h3 className="text-xl font-normal text-gray-900 dark:text-white">
            Monitoring teams across Pakistan.{" "}
            <span className="text-gray-500 dark:text-gray-400">Karachi, Lahore, Islamabad — all in one view.</span>
          </h3>
        ...
        <div className="rounded-none border border-gray-200 dark:border-gray-800 bg-muted p-6 space-y-4">
          ...
          <h3 className="text-xl font-normal text-gray-900 dark:text-white">
            ...
            <span className="text-gray-500 dark:text-gray-400">AI-generated scores updated every 60 seconds.</span>
          </h3>
          <MonitoringChart />
        </div>
        ...
        <div className="grid sm:grid-cols-2 rounded-none bg-card">
          <FeatureCard
            ...
            image="/1.png"
            title="AI Logging"
            subtitle="Verified Work"
            description="Our AI confirms actual keyboard/mouse activity."
          />
          <FeatureCard
            ...
            description="View employee screens instantly from your mobile."
          />
        </div>
      </div>
    </section>
...
const messages: Message[] = [
    {
      ...
      time: "1m ago",
      content: "Idle time detected for User #402 (Islamabad).",
      color: "from-red-400 to-red-600",
    },
    {
      title: "AI Summary",
      time: "3m ago",
      content: "Sarah C. has completed the Auth Module task.",
      color: "from-green-500 to-emerald-600",
    },
    {
      title: "System Update",
      time: "6m ago",
      content: "Live streams established for 12 new nodes.",
      color: "from-blue-400 to-indigo-600",
    },
    {
      title: "Productivity Report",
      time: "10m ago",
      content: "Weekly efficiency up by 14% across the board.",
      color: "from-amber-400 to-orange-600",
    },
  ];

const TracFeaturedMessageCard = () => {
  return (
...
const ChartTooltip = RechartsPrimitive.Tooltip as unknown as React.FC<RechartsPrimitive.TooltipProps<any, any>>
