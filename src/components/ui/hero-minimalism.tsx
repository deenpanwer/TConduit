...
.content .desc {
  ...
  max-width: 680px;
      ...
      <header className="header">
        ...
        <button className="cta" type="button" onClick={() => window.location.href='/time-tracking'}>
          Book Demo
        </button>
      </header>
      ...
      <main className="hero">
        <div>
          <div className="kicker">The Absolute Standard</div>
          <h1 className="title">Track less.<br/>Know more.</h1>
          <p className="subtitle">The best way to track employee hours in Pakistan. AI-powered and effortless.</p>
        </div>
      </main>

      {/* Bottom content */}
      <section className="content">
        <div className="tag">Optimized for Remote Teams</div>
        <div className="heading">Centralized Command. Real-time Visibility.</div>
        <p className="desc">
          Automate time logging, view live activity, and pay only for true work with the smartest net monitor available.
        </p>
      </section>
    </section>
  );
