...
interface FreePCInvoiceCanvasProps {
...
export function FreePCInvoiceCanvas({ invoice, subtotal, brandingLogo, invoiceRef }: FreePCInvoiceCanvasProps) {
        ...
        {pages.map((pageItems, pageIdx) => (
          ...
          >
            <motion.div 
              ...
              className="invoice-page w-[800px] h-[1131px] bg-white text-slate-900 shadow-[0_20px_60px_rgba(0,0,0,0.15)] rounded-sm p-12 md:p-16 flex flex-col absolute top-0 left-0 shrink-0"
              style={{
