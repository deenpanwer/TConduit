...
const MetricBox = ({ icon: Icon, label, value, subValue }: MetricProps) => (
  <div className="flex flex-col p-4 md:p-6 rounded-[2rem] bg-gray-50/50 dark:bg-white/5 border border-gray-100 dark:border-white/5 group hover:scale-[1.02] transition-all duration-500 relative overflow-hidden h-full min-w-0">
    ...
    <div className="flex items-center space-x-3 mb-3 relative z-10">
      ...
      <span className="text-[8px] md:text-[9px] font-black font-poppins uppercase tracking-[0.2em] text-gray-400 truncate">{label}</span>
    </div>
    <div className="flex flex-col relative z-10 mt-auto min-w-0">
      <span className="text-lg md:text-xl xl:text-2xl font-black font-poppins text-gray-900 dark:text-white leading-tight tracking-tighter-custom truncate">{value}</span>
      ...
      <div className="flex flex-col 2xl:flex-row 2xl:items-center gap-8 md:gap-10 2xl:gap-16 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-10 shrink-0">
          ...
          >
            ...
            >
                {logoUrl ? (
                  <img src={logoUrl} className="w-full h-full object-cover transition-transform duration-700 hover:scale-110" alt={orgName} />
                ) : (
                  <div className="w-full h-full bg-black/20 animate-pulse" />
                )}
            </motion.div>
            <div className={`absolute -bottom-1 -right-1 size-5 rounded-full border-4 border-card z-20 ${isOnline ? 'bg-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.5)]' : 'bg-gray-400'}`} />
          </div>
          ...
          <div className="min-w-0">
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 mb-4">
              ...
              <span className="text-[9px] font-black font-poppins text-blue-600 dark:text-blue-400 uppercase tracking-widest">
                Executive Management
              </span>
            </div> 
            <h1 className="text-3xl md:text-6xl 2xl:text-7xl font-black font-poppins text-gray-900 dark:text-white tracking-tighter leading-[0.85] uppercase break-words max-w-[300px] md:max-w-none">
            ...
            <div className="mt-6 flex items-center space-x-4 group/owner">
              <div className="flex flex-col">
                ...
                <span className="text-xs md:text-sm font-black font-poppins text-gray-900 dark:text-white transition-colors duration-300">
