      ...
      >
        ...
        >
          ...
          >
            {/* 1. TEXT MESSAGE TYPE */}
            {msgType === "text" && (
              <p className="text-[13px] leading-relaxed font-semibold whitespace-pre-wrap">{message.text}</p>
            )}
          ...
          {/* Timestamp on hover */}
          <span className={cn(
            "text-[9px] font-bold uppercase tracking-widest text-muted-foreground/50 mt-1 px-1 opacity-0 group-hover:opacity-100 transition-opacity",
