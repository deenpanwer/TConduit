...
const FEATURES = [
  {
    title: "AI Drafts.",
    description: "Write better emails in half the time. Trac AI drafts responses that sound just like you.",
    icon: Sparkles,
    color: "blue"
  },
  {
    title: "Smart Campaigns.",
    description: "Run automated outreach that feels personal. Trac AI sends follow-ups at the perfect time.",
    icon: Send,
    color: "emerald"
  },
  {
    title: "Deep Tracking.",
    description: "Know exactly when your emails are opened and which links are clicked with real-time alerts.",
    icon: BarChart2,
    color: "purple"
  },
  {
    title: "Unified Inbox.",
    description: "Manage all your accounts in one place. Connect Gmail, Outlook, and more with a single click.",
    icon: Mail,
    color: "rose"
  }
];
      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden flex flex-col items-center text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/5 border border-blue-500/20 mb-8">
            ...
            <span className="text-xs font-black uppercase tracking-widest text-blue-600 dark:text-blue-400">Communication Mastery</span>
          </div>

          <h1 className="text-5xl md:text-8xl font-black leading-[0.9] tracking-tighter mb-8 uppercase italic">
            Email that <br />
            <span className="text-blue-500 underline underline-offset-8 decoration-blue-500/20">reaches the goal.</span>
          </h1>

          <p className="text-xl md:text-2xl text-muted-foreground font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
            The smartest way to handle your business mail. Trac AI automates your inbox so you can focus on the message.
          </p>
          ...
          <div className="bg-white dark:bg-[#0a0a0a] rounded-[2.5rem] border border-black/5 dark:border-white/10 p-8 shadow-2xl overflow-hidden min-h-[400px] relative text-left">
             ...
             <div className="space-y-6">
                <div className="flex items-center gap-4">
                   <div className="size-10 rounded-full bg-black/5" />
                ...
                <div className="pt-8 flex gap-4">
                   <div className="h-10 w-32 bg-blue-500/20 rounded-full" />
