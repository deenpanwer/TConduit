...
const FEATURES = [
  {
    ...
    description: "Find the best vendors and negotiate better prices automatically. Trac AI handles the search for you.",
    icon: Sparkles,
    color: "emerald"
  },
  {
    title: "Automated Orders.",
    description: "Never run out of essential supplies. Trac AI triggers re-orders based on your real-time stock levels.",
    icon: Zap,
    color: "orange"
  },
  {
    title: "Vendor Portal.",
    description: "Manage all your suppliers in one place. Streamline communication and track deliveries effortlessly.",
    icon: Users,
    color: "blue"
  },
  {
    title: "Cost Control.",
    description: "Get deep insights into your spending habits and find opportunities to save money across your business.",
    icon: BarChart2,
    color: "rose"
  }
];
      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden flex flex-col items-center text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/5 border border-emerald-500/20 mb-8">
            ...
            <span className="text-xs font-black uppercase tracking-widest text-emerald-600 dark:text-emerald-400">Buying Power</span>
          </div>

          <h1 className="text-5xl md:text-8xl font-black leading-[0.9] tracking-tighter mb-8 uppercase italic">
            Procurement made <br />
            <span className="text-emerald-500 underline underline-offset-8 decoration-emerald-500/20">profitable.</span>
          </h1>

          <p className="text-xl md:text-2xl text-muted-foreground font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
            The smartest way to buy for your business. Trac AI optimizes your supply chain so you can focus on the growth.
          </p>
        ...
        <div className="mt-20 w-full max-w-5xl relative group">
          ...
          <div className="bg-white dark:bg-[#0a0a0a] rounded-[2.5rem] border border-black/5 dark:border-white/10 p-8 shadow-2xl overflow-hidden min-h-[400px] relative text-left">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-6 rounded-3xl bg-[#f5f5f7] dark:bg-[#111] border border-black/5">
                   <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-4">Open Purchase Orders</div>
                   <div className="text-3xl font-black text-emerald-500 font-poppins">24 Active</div>
                </div>
                <div className="p-6 rounded-3xl bg-[#f5f5f7] dark:bg-[#111] border border-black/5">
                   <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-4">Next Delivery</div>
                   <div className="text-3xl font-black text-orange-500 font-poppins">Tomorrow, 10 AM</div>
                </div>
             </div>
