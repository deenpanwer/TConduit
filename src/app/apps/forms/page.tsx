...
const FEATURES = [
  {
    ...
    description: "Create beautiful forms in seconds. Drag and drop fields, and watch your data flow into Trac AI automatically.",
    icon: Layout,
    color: "emerald"
  },
  {
    title: "Smart Data Sorting.",
    description: "Trac AI automatically categorizes and sorts your responses so you can act on them immediately.",
    icon: Zap,
    color: "purple"
  },
  {
    title: "Team Collaboration.",
    description: "Share forms with your team and collaborate on responses in real-time. No more messy email chains.",
    icon: Users,
    color: "blue"
  },
  {
    title: "Secure & Compliant.",
    description: "Your data is always protected with enterprise-grade security and full privacy compliance.",
    icon: ShieldCheck,
    color: "rose"
  }
];
      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden flex flex-col items-center text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/5 border border-emerald-500/20 mb-8">
            ...
            <span className="text-xs font-black uppercase tracking-widest text-emerald-600 dark:text-emerald-400">Data Collection</span>
          </div>

          <h1 className="text-5xl md:text-8xl font-black leading-[0.9] tracking-tighter mb-8 uppercase italic">
            Forms that <br />
            <span className="text-emerald-500 underline underline-offset-8 decoration-emerald-500/20">actually get answers.</span>
          </h1>

          <p className="text-xl md:text-2xl text-muted-foreground font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
            The easiest way to collect data. Trac AI turns simple forms into powerful insights for your business.
          </p>
             ...
             <div className="space-y-6 max-w-lg mx-auto">
                {[
                  ...
                  <div key={field} className="text-left">
                     <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-2">{field}</div>
                     <div className="h-12 w-full bg-[#f5f5f7] dark:bg-[#111] border border-black/5 rounded-xl" />
                  </div>
                ))}
             </div>
