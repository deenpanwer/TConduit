...
export default function PosDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6 p-6 lg:p-8 bg-slate-50/50 dark:bg-slate-950 min-h-screen text-foreground">
      {/* Header */}
      <div className="flex justify-between items-center pb-4 border-b border-border">
        <div>
            <h1 className="text-3xl font-black uppercase tracking-tighter">Operations Hub</h1>
