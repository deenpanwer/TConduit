      ...
      <main className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose dark:prose-invert prose-lg max-w-none 
            ...
            <p>
              You may cancel your subscription at any time. To cancel your subscription, please contact us at <strong>info@traconomics.com</strong> or through your account dashboard.
            </p>
            <p>
            ...
            <p>
              To request a refund, please contact our support team at <strong>info@traconomics.com</strong> with your order details.
            </p>
            <p>
            ...
            <ul>
              <li><strong>Email:</strong> info@traconomics.com</li>
