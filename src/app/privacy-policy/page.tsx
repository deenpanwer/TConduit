  ...
  return (
    <div className="bg-background min-h-screen">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-4 text-foreground">Privacy Policy for Traconomics</h1>
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">For users of our Windows application</h2>
            <p>
                This section of our Privacy Policy applies specifically to users of our application for Windows, available
                from the Microsoft Store.
            </p>

            <h3 className="text-xl font-bold mt-4 mb-2">Personal Information</h3>
            <p>
                Our application for Windows does not collect or transmit any user's personal information. All data entered by the user, as well as any data generated by the application, is stored locally on the user's device. We do not have access to this information.
            </p>

            <h3 className="text-xl font-bold mt-4 mb-2">Application Telemetry</h3>
            <p>
                To help us improve our application, we may collect anonymous, aggregate telemetry data. This data includes information such as device type, operating system version, and application usage patterns. This information is not personally identifiable and is used solely for the purpose of improving the user experience and the overall quality of our application.
            </p>

            <h3 className="text-xl font-bold mt-4 mb-2">Third-Party Services</h3>
            <p>
                Our application for Windows does not use any third-party services that would require us to share your personal information. 
            </p>
        </div>
      </div>
    </div>
