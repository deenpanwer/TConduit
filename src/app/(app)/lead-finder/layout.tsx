...
import { LeadFinderSidebar } from "./lead-finder-sidebar";
        ...
        <header className="lg:hidden flex items-center justify-between px-4 h-14 border-b bg-card shrink-0 z-40">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="font-poppins font-black text-xs uppercase tracking-tighter leading-none text-indigo-600 dark:text-indigo-400">
                LEAD FINDER
              </span>
